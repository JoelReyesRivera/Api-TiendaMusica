...
playlist.belongsToMany(tracks,{foreignKey:'PlayListId', as:"Playlist_track",through: playlist_track })
tracks.belongsToMany(playlist,{foreignKey:'TrackId', as:"Playlist_track",through: playlist_track})
